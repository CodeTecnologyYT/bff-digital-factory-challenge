package pe.com.scotibank.bff.digital.factory.challenge.shared.aspects;
...
public class LoggingAspect {
     ...
     * @return {@link Object}
     */
    @Around("execution(public * pe.com.scotibank.bff.digital.factory.challenge..application..*(..))")
    public Object logging(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            log.error("[{}][{}][BDFC_FINEX] Exception: {}", className, methodName, e.getMessage(), e);
            throw e;
        }
    }
